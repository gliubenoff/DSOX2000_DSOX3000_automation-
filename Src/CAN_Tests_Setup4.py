...
measure_can = keysight_DSOX2000A_3000A.Oscilloscope(address)
...
measure_can.send(':CHANnel1:BWLimit ON')  # options ON | OFF
...
measure_can.send(':CHANnel2:BWLimit ON')  # options ON | OFF
